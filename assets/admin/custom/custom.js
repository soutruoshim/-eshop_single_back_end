                ...
                function(e, t, a) {
                    ...
                    n = function(e, t, a) {
                            ...
                            n.on("created", (function(t) {
                                ...
                                return n.elem("feGaussianBlur", { in: "SourceAlpha",
                                    stdDeviation: "24",
                                    result: "offsetBlur"
                                }), n.elem("feOffset", {
                                    dx: "0",
                                    dy: "32"
                                }), n.elem("feBlend", { in: "SourceGraphic",
                                    mode: "multiply"
            ...
            preConfirm: function() {
                return new Promise((resolve, reject) => {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: base_url + 'admin/orders/update_orders',
                        data: { orderid: orderid, field: field, val: val, deliver_by: deliver_by, json: json, [csrfName]: csrfHash },
                        dataType: 'json',
                        success: function(result) {
            ...
            preConfirm: function() {
                return new Promise((resolve, reject) => {
                    $.ajax({
                        ...
                        data: { orderid: orderid, field: field, val: val, deliver_by: deliver_by, json: json, otp: post_otp, [csrfName]: csrfHash },
                        dataType: 'json',
                        success: function(result) {
                    ...
                    if (message.attachments.length > 0) {
                        message.attachments.forEach(atch => {
                            atch_html += "<div class='container-fluid image-upload-section'>" +
                                "<a class='btn btn-danger btn-xs mr-1 mb-1' href='" + atch.media + "'  target='_blank' alt='Attachment Not Found'>Attachment</a>" +
...
$(document).on('click', '.mark-all-as-read-alert', function(e) {
    ...
    .then((willDelete) => {
        if (willDelete) {
            $.ajax({
                url: base_url + 'admin/Notification_settings/mark_all_as_read/' + user_id,
                type: "POST",
