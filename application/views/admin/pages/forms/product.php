                        ...
                        <form class="form-horizontal" action="<?= base_url('admin/product/add_product'); ?>" method="POST" enctype="multipart/form-data" id="save-product">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label for="pro_input_text" class="col-form-label ml-2">Identification of Product</label>
                                    <div class="col-md-12">
                                        <input type="text" class="form-control" id="product_identity" placeholder="Product Identification Number" name="product_identity" value="<?= (isset($product_details[0]['product_identity'])) ? $product_details[0]['product_identity'] : "" ?>">
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-8">
                                            ...
                                            <div class="row col mt-3">
                                                <div class="col-md-6">
                                                    ...
                                                    <select class='form-control' name='deliverable_type' id="deliverable_type">
                                                        ...
                                                        <?php } ?> <option value=<?= INCLUDED ?> <?= (isset($product_details[0]['deliverable_type']) &&  $product_details[0]['deliverable_type'] == INCLUDED) ? 'selected' : ''; ?>>Included</option>
                                        ...
                                        <div class="row col mt-3">
                                            ...
                                            <div class="col-md-2 col-xs-6 <?= (isset($product_details[0]['is_cancelable']) && $product_details[0]['is_cancelable'] == 1) ? '' : 'collapse' ?>" id='cancelable_till'>
                                            ...
                                            <div class="col-md-2 col-xs-6">
                                                ...
                                                <input type="checkbox" name="is_attachment_required" <?= (isset($product_details[0]['is_attachment_required']) && $product_details[0]['is_attachment_required'] == '1') ? 'Checked' : '' ?> data-bootstrap-switch data-off-color="danger" data-on-color="success">
                                            </div>
                                        </div>
                                                            ...
                                                            ?>
                                                                ...
                                                                <div class="form-group simple-product-level-stock-management <?= $HideStatus ?>">
                                                                    ...
                                                                    <div class="col col-xs-12">
                                                                        ...
                                                                        <input type="number" min="1" name="total_stock_variant_type" class="col form-control variant-stock-mustfill-field" value="<?= (intval($product_details[0]['stock_type']) == 1 && isset($product_variants[0]['id']) && !empty($product_variants[0]['stock'])) ? $product_variants[0]['stock'] : '' ?>">                                                                    <div class="col col-xs-12">
                                    ...
                                    <div class="card-body pad">
                                        ...
                                        <div class="mb-3">
                                            <textarea name="pro_input_description" class="textarea" placeholder="Place some text here"><?= (isset($product_details[0]['id'])) ? output_escaping(str_replace('\r\n', '&#13;&#10;', $product_details[0]['description'])) : ''; ?></textarea>
                                        </div>
